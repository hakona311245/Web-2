...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $currentPwd = $_POST['current_pwd'];  // Assumes you'll handle current password check inside the method
    $newPwd = $_POST['new_pwd'];

    // Call update method
    $updateResult = $obj->updateUserDetails($_SESSION['user_id'], $firstName, $lastName, $userName, $email, $address, $ward, $district, $city, $phone, $currentPwd, $newPwd);
